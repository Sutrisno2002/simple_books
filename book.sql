...
-- Dumping data for table book.books: ~2 rows (approximately)
INSERT IGNORE INTO `books` (`id`, `title`, `description`, `author`, `category_id`, `image`, `created_at`, `updated_at`) VALUES
	(8, 'hhh', NULL, 'sutrisno0000', 5, 'books/idgiyXviJPZ3dGizxiuYGegVkLRwmxpYL9HQPMtr.png', '2024-07-27 21:17:13', '2024-07-27 21:41:10'),
	(9, 'aaaaa', NULL, 'aaaa', 4, 'books/O8x7pdT0rRq6eDP9uIEKO45VFa8iY7ausNlZBZbO.jpg', '2024-07-27 21:40:45', '2024-07-27 21:40:45');
...
INSERT IGNORE INTO `categories` (`id`, `name`, `created_at`, `updated_at`) VALUES
	(3, 'susu', '2024-07-27 00:21:45', '2024-07-27 00:21:45'),
	(4, 'aaa', '2024-07-27 00:23:27', '2024-07-27 00:23:27'),
	(5, 'err', '2024-07-27 19:19:22', '2024-07-27 19:19:22'),
	(6, 'akaka', '2024-07-27 20:09:00', '2024-07-27 20:09:00');
...
INSERT IGNORE INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(5, '2024_07_26_042537_create_categories_table', 1),
	(6, '2024_07_26_042543_create_books_table', 1);
...
INSERT IGNORE INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'sutrisno', 'sutrisno112002@gmail.com', NULL, '$2y$12$5peD0YXxAeTHdMcqL2Ord.BvPWk8A0ZcOgVcEtIwIoRez/f9DYgS.', NULL, '2024-07-25 21:37:50', '2024-07-25 21:37:50');
